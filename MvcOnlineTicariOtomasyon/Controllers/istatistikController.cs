...
namespace MvcOnlineTicariOtomasyon.Controllers
{
    public class istatistikController : Controller
    {
        ...
        public ActionResult KolayTablolar()
        {
            ...
            var siralisorgu = sorgu.OrderByDescending(x => x.Sayi).ToList();
            return View(siralisorgu);
        }
        ...
        public PartialViewResult Partial4()
        {
            ...
            var siralisorgu5 = sorgu5.OrderByDescending(x => x.Sayi).ToList();
            return PartialView(siralisorgu5);
        }
    }
}